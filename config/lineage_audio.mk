...
ALARM_PATH := vendor/ironlos/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/ironlos/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/ironlos/prebuilt/common/media/audio/ringtones
